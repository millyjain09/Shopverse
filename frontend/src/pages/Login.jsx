    ...
    >
      ...
      >
        ...
        <div className="text-center mb-6 sm:mb-8">
          ...
          <p className="text-teal-600/70 text-xs sm:text-sm mt-1">
        ...
        <form className="flex flex-col gap-4 sm:gap-5" onSubmit={handleLogin}>
          ...
          <div
            onClick={googleLogin}
            className="
              w-full py-2.5 sm:py-3 rounded-xl border border-teal-200
              bg-white hover:bg-teal-50
              flex items-center justify-center gap-3
              text-teal-800 font-medium text-sm sm:text-base
